...
- **Refactor while green.** After each minimal implementation passes, clean up that slice without changing behavior, then keep the tests green before starting the next red test.
